...
export default function About() {
  return (
    <div className="w-full">
      ...
      <div className="mx-auto mt-10 flex max-w-6xl flex-col items-center gap-8 px-4 pb-12 sm:mt-12 sm:gap-10 sm:px-6 sm:pb-16 md:mt-14 md:max-w-5xl md:flex-row md:items-start md:gap-10 md:px-8 lg:mt-16 lg:max-w-6xl lg:gap-12 lg:pb-20 xl:max-w-7xl xl:gap-16 2xl:max-w-[90rem] 2xl:gap-20 2xl:pb-24">
        <img
          className="h-auto w-full max-w-md rounded-lg object-cover shadow-lg sm:max-w-lg md:max-w-sm lg:max-w-md xl:max-w-lg 2xl:max-w-xl"
          src={Girlfight}
          alt="girl fighting"
        />
        <div className="flex w-full max-w-xl flex-col items-start text-base sm:text-lg md:max-w-md md:text-xl lg:max-w-lg lg:text-2xl xl:max-w-2xl xl:text-2xl 2xl:max-w-3xl 2xl:text-3xl">
          <h1 className="font-montserrat text-3xl font-normal sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl">
            Our Story
          </h1>
      ...
      <div className="bg-white pb-12 pt-8 sm:pb-16 sm:pt-10 md:pb-20 md:pt-12 lg:pb-24 lg:pt-14 xl:pb-28 2xl:pb-32">
        <h1 className="font-montserrat px-4 pb-8 text-center text-3xl font-extralight capitalize leading-tight sm:text-4xl sm:pb-10 md:text-5xl md:pb-12 lg:text-6xl lg:pb-14 xl:text-7xl 2xl:text-8xl">
          Now,
          <br /> How will your story <br /> <span className="text-red-600">Finish?</span>
        </h1>
        <div className="mx-auto flex max-w-[100rem] flex-wrap items-center justify-center gap-6 px-4 pb-8 sm:gap-8 sm:pb-10 md:gap-10 md:pb-12 lg:gap-12 xl:gap-14 2xl:gap-16">
          {[Boxer_champ1, Boxer_champ2, Boxer_champ3].map((src, i) => (
            <img
              key={i}
              className="h-auto w-full max-w-[18rem] rounded-md object-cover shadow-md sm:max-w-xs md:max-w-sm lg:max-w-md xl:max-w-lg 2xl:max-w-xl"
              src={src}
        ...
        <div className="flex justify-center px-4">
          <Link to="/SignUp" className="inline-block">
            <button
              type="button"
              className="font-montserrat rounded-full bg-green-700 px-8 py-4 text-base font-extralight uppercase text-white transition-opacity hover:opacity-80 sm:px-10 sm:py-5 sm:text-lg md:px-12 md:py-6 md:text-xl lg:px-14 lg:py-7 lg:text-2xl xl:px-16 xl:py-8 xl:text-3xl 2xl:px-20 2xl:py-9 2xl:text-4xl"
            >
              Start Today!
            </button>
          </Link>
